...
import sample1 from "../img/sampleCard1.jpg";
import sample2 from "../img/sampleCard2.jpg";
import sample3 from "../img/sampleCard3.jpg";
import guestList from "../img/iconGuestList.png";
import lightBulb from "../img/iconLightBulb.png";
            ...
            <div className="row">
              <div className="col s12 m4">
                <div className="icon-block">
                  <div className="center">
                    <img className="landing-icon" src={guestList} alt="Mailbox" />
                  </div>
              ...
              <div className="col s12 m4">
                <div className="icon-block">
                  <div className="center">
                    <img className="landing-icon" src={lightBulb} alt="Light bulb" />
                  </div>
                  <h5 className="center">Simple. Smooth. Straightforward.</h5>
                  <p className="light">CraftiCards removes the hassle of updating and keeping track of who's coming and who's not. We streamline the process with a minimalist interface that's easy for everyone. Creating a new RSVP might take about one minute- replying to one takes about 10 seconds. We'll take care of all the boring stuff from there.</p>
                </div>
              </div>
